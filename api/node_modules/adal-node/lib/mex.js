...
var xmlutil = require('adal-node/lib/xmlutil');
var select = xmlutil.xpathSelect;

var Namespaces = require('adal-node/lib/constants').XmlNamespaces;

var WSTrustVersion = require('adal-node/lib/constants').WSTrustVersion;
